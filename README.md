...
**利用ツール、利用サイト**  ***・Visual Studio Code  
・サクラエディタ  
・ペイント(Microsoft Paint)  
・Snipping Tool(画面キャプチャーツール)  
・ChatGPT  https://chatgpt.com/  
・GitHub  https://github.co.jp/
・ラッコツール　動画をGIFに変換    https://rakko.tools/tools/86/
Qiita　【保存版】Webフロントエンド基礎力（初心者向け）https://qiita.com/teradonburi/items/43c52d7cffc318e9b1e9
